                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
                          ...
                          <td>
                            <button class="btn btn-success btn-sm edit btn-flat" data-id="<?php echo $row['empid']; ?>"><i class="fa fa-edit"></i> Sửa</button>
                            <button class="btn btn-danger btn-sm delete btn-flat" data-id="<?php echo $row['empid']; ?>"><i class="fa fa-trash"></i> Xóa</button>
                          </td>
                        </tr>
                      <?php
                    }
