  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Nhân viên</li>
        <li class="active">Ứng trước tiền mặt</li>
      </ol>
    </section>
    <!-- Main content -->
                    ...
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr>
                          ...
                          <td>
                            <button class='btn btn-success btn-sm edit btn-flat' data-id='".$row['caid']."'><i class='fa fa-edit'></i> Sửa</button>
                            <button class='btn btn-danger btn-sm delete btn-flat' data-id='".$row['caid']."'><i class='fa fa-trash'></i> Xóa</button>
                          </td>
                        </tr>
                      ";
                    }
