          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
          		  <div class="form-group">
                  	<label for="firstname" class="col-sm-3 control-label">Tên</label>
                ...
                <div class="form-group">
                  	<label for="lastname" class="col-sm-3 control-label">Họ</label>
                ...
                <div class="form-group">
                    <label for="schedule" class="col-sm-3 control-label">Lịch</label>
                ...
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">Hình ảnh</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_firstname" class="col-sm-3 control-label">Tên</label>
                ...
                <div class="form-group">
                    <label for="edit_lastname" class="col-sm-3 control-label">Họ</label>
                ...
                <div class="form-group">
                    <label for="edit_contact" class="col-sm-3 control-label">Số điện thoại</label>
                ...
                <div class="form-group">
                    <label for="edit_schedule" class="col-sm-3 control-label">Lịch</label>
...
<div class="modal fade" id="edit_photo">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Đóng</button>
              <button type="submit" class="btn btn-success btn-flat" name="upload"><i class="fa fa-check-square-o"></i> Lưu</button>
              </form>
            </div>
        </div>
    </div>
