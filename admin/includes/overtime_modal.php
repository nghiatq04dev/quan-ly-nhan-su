    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Thêm làm thêm giờ</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="datepicker_add" class="col-sm-3 control-label">Thời gian</label>
                ...
                <div class="form-group">
                  	<label for="hours" class="col-sm-3 control-label">Số giờ</label>
                ...
                <div class="form-group">
                  	<label for="mins" class="col-sm-3 control-label">Số phút</label>
                 ...
                 <div class="form-group">
                    <label for="rate" class="col-sm-3 control-label">Tỷ giá</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="datepicker_edit" class="col-sm-3 control-label">Thời gian</label>
                ...
                <div class="form-group">
                    <label for="hours_edit" class="col-sm-3 control-label">Số giờ</label>
                ...
                <div class="form-group">
                    <label for="mins_edit" class="col-sm-3 control-label">Số phút</label>
                 ...
                 <div class="form-group">
                    <label for="rate_edit" class="col-sm-3 control-label">Tỷ giá</label>
